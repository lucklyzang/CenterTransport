...
import { generateDispatchTaskManyNew, queryTransConfig } from '@/api/taskScheduling.js'
...
export default {
  ...
  computed: {
    ...mapGetters(["userInfo","schedulingTaskDetails","operateBtnClickRecord","transportantTaskMessage","templateType","temporaryStorageCreateDispathTaskMessage"]),
    proId () {
